...
> Если вы подключаете интеграцию впервые, начните с [короткого руководства и выберите свой язык](custom-verification/README.md). Этот документ — полная спецификация протокола и production-требований.
