...
public record FeatureSettings(
    ...
    public FeatureSettings {
        ...
        if (sessionLifetime.isNegative() || authTimeout.isNegative() || reminderInterval.isNegative()
                ...
                || totpIssuer == null || totpIssuer.isBlank() || dialogs == null) {
    ...
    public static FeatureSettings defaults() {
        return new FeatureSettings(
                true, Duration.ofMinutes(60), Duration.ofSeconds(60), Duration.ofSeconds(10), true, Duration.ofSeconds(60),
                10, 10, Set.of("127.0.0.1"),
                true, 3, Duration.ofSeconds(60), "Minecraft Server", 16,
                true, DialogSettings.defaults(), true, false, false
        );
    }
}
