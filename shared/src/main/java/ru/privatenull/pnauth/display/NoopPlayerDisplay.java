...
public final class NoopPlayerDisplay implements PlayerDisplay {
    ...
    private static final class Titles extends Base implements TitleHandle {Titles(UUID id,String name){super(id,name);}public void title(String v){}public void subtitle(String v){}public void timings(Duration a,Duration b,Duration c){}public void repeatInterval(Duration v){}public void showNow(){}public void clear(){}public void release(){}}
